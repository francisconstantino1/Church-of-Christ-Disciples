...
$current_page = basename($_SERVER['PHP_SELF']); // Added to dynamically set active class

// Simulated dashboard data - in a real application, this would come from a database
$dashboard_stats = [
    "total_members" => 150,
    "upcoming_events" => 5,
    "pending_prayers" => 3,
        ...
        <main class="content-area">
            ...
            <div class="dashboard-content">
                ...
                <div class="card">
                    ...
                    <p>₱<?php echo number_format($dashboard_stats["total_donations"], 2); ?></p>
                </div>
            </div>
        </main>
    </div>
